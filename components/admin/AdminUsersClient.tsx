...
export default function AdminUsersClient({
  ...
  const toggleRole = async (userId: string, currentRole: string) => {
    ...
    if (currentRole === "SUPER_ADMIN") {
      toast.error("Cannot change a super admin role");
      return;
    }
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="text-left px-4 py-3.5 font-bold text-gray-600 hidden sm:table-cell">
                  Email
                </th>
                <th className="text-left px-4 py-3.5 font-bold text-gray-600">Role</th>
                <th className="text-right px-4 py-3.5 font-bold text-gray-600 hidden md:table-cell">
                  Orders
                </th>
                <th className="text-right px-4 py-3.5 font-bold text-gray-600 hidden lg:table-cell">
                  Joined
                </th>
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 text-right">
                      <button
                        ...
                        disabled={
                          !canManageRoles || user.id === currentUserId || isSuperAdmin
                        }
                      ...
                      >
                        {isSuperAdmin ? "Locked" : isAdmin ? "To User" : "To Admin"}
                      </button>
                    </td>
                  </tr>
                );
